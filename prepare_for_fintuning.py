...
def parse_args():
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=["data/gpt3_generations/is_clf_or_not_llama_template_1.jsonl"],
    )
    parser.add_argument(
        "--output_dir",
...
if __name__ == "__main__":
    ...
    # # Load from exsiting generated jsonl file
    # with open("data/gpt3_generations/all_instances_82K.jsonl") as fin:
    #     lines = fin.readlines()
    #     training_instances = []
    #     for line in lines:
    #         data = json.loads(line)
    #         training_instances.append((data["instruction"], data["input"], data["output"]))
